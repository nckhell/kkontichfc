  ...
  render() {
    ...
    return (
      <Layout showGrassHeader>
        <NextSeo
          config={{
            title: "Online registratie | Vermant-Cup | Jeugd",
            description: `Online registratie voor de Vermant-Cup van K. Kontich F.C.`,
            ...
            <div className="px-4 mt-4 md:mt-5 lg:mt-8 container mx-auto text-left">
              <div className="body-content w-full">
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      <u>Zondag 22 augustus 2021:</u> <b>U12 & U13</b> (in de
                      voormiddag) & <b>U10 & U11</b> (in de namiddag);
                    </li>
                    <li>
                      <u>Zondag 29 augustus 2021:</u> <b>U8 & U9</b> (in de
